...
export default function CreateEvent({ data }) {
  ...
  return (
    <>
      <button
        id="createButton"
        className="w-3/5 font-oswald px-6 py-3 mb-1 mr-1 text-xl font-bold text-white transition-all duration-150 ease-linear rounded shadow outline-none mx-72 bg-cyan-600 active:bg-cyan-600 hover:shadow-lg focus:outline-none"
        type="button"
